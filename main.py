...
# # Filtragem com filtro media mascara 15 - IMG2
print("Filtragem com filtro media mascara 15 - IMG2")
mean_out = new_filter.mean(img2, mask=15).evaluate()
newImage = Image.fromarray(mean_out.astype('uint8').reshape((height2, width2)), 'L')
newImageName = path_out_imgs + "IMG2/" + 'IMG2_mean_15_out.png'
newImage.save(newImageName)
...
# Filtragem com filtro mediana mascara 15 - IMG2
print("Filtragem com filtro mediana mascara 15 - IMG2")
mean_out = rank_filter.median(img2, mask=15).evaluate()
newImage = Image.fromarray(mean_out.astype('uint8').reshape((height2, width2)), 'L')
newImageName = path_out_imgs + "IMG2/" + 'IMG2_median_15_out.png'
newImage.save(newImageName)
...
# # Filtragem com filtro máximo mascara 9 - IMG2
print("Filtragem com filtro de maximo mascara 9 - IMG2")
mean_out = rank_filter.maximum(img2, mask=9).evaluate()
newImage = Image.fromarray(mean_out.astype('uint8').reshape((height2, width2)), 'L')
newImageName = path_out_imgs + "IMG2/" + 'IMG2_max_9_out.png'
newImage.save(newImageName)
